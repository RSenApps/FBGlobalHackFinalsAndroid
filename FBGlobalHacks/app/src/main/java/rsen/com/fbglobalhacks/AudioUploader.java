...
public class AudioUploader {
    ...
    public static void doFileUpload(String selectedPath){
        String upLoadServerUri = "http://159.203.243.184:5000/";
        ...
        else
        {
            try {
                ...
                dos.writeBytes("Content-Disposition: form-data; name=\"" + timeStamp + "," + Locale.getDefault().getLanguage() + "\";filename=\""
                        + timeStamp + "," + Locale.getDefault().getLanguage() + "\"" + lineEnd);
